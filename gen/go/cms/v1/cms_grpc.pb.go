...
func (UnimplementedReEarthCMSServer) CheckAliasAvailability(context.Context, *AliasAvailabilityRequest) (*AliasAvailabilityResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CheckAliasAvailability not implemented")
}
...
func (UnimplementedReEarthCMSServer) GetModelExportURL(context.Context, *ModelExportRequest) (*ExportURLResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetModelExportURL not implemented")
}
func (UnimplementedReEarthCMSServer) GetModelGeoJSONExportURL(context.Context, *ExportRequest) (*ExportURLResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetModelGeoJSONExportURL not implemented")
}
func (UnimplementedReEarthCMSServer) StarProject(context.Context, *StarRequest) (*StarResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method StarProject not implemented")
}
...
func RegisterReEarthCMSServer(s grpc.ServiceRegistrar, srv ReEarthCMSServer) {
	// If the following call panics, it indicates UnimplementedReEarthCMSServer was
